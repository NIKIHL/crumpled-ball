...
//find the bug in the below code
	 var dustbinImg = addImage("dustbin.png");
	var paperImg = addImage("paper.png");
...
image(image(paperImg),ball.position.x,ball.position.y,radius,radius);

	// use image() command to add dustbin image in the canvas.
	image(image(dustbinImg),1185, 570, 200,200);
